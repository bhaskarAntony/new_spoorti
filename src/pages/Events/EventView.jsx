    ...
    return (
        <div className='event-container'>
           ...
           <div className="event-view-banner bg-primary text-center d-flex align-items-center justify-content-center flex-column" >
                ...
                <h1 className='display-3 fw-bold'>Event: {event.venue}</h1>
            ...
            <div className="room-book-card">
                <div className="row align-item-center">
                    <div className="col-12 col-md-3">
                        <div className="form-group">
                            ...
                            <div className="input-group mt-2">
                                ...
                                <input type="text" className="form-control" id='venue' value={event.venue} placeholder='eventname' onChange={handleChange} disabled />
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-3">
                        <div className="form-group">
                            ...
                            <div className="input-group mt-2">
                                <span className="input-group-text" id="basic-addon1"><i className="bi bi-calendar2-week fs-4 text-primary"></i></span>
                                <input type="date" className="form-control" id='eventDate' onChange={handleChange} />
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-md-3">
                    ...
                    <div className="col-12 col-md-3">
                        <div className="form-group">
                            <button className="btn btn-primary w-100 d-flex align-items-center justify-content-between" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">Check Availability <i className="bi bi-arrow-right"></i></button>
                        </div>
                    </div>
                </div>
            </div>
